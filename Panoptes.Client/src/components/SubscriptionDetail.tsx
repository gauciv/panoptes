  ...
  return (
    <div className="flex flex-col gap-6 w-full animate-in fade-in duration-300 relative">
      ...
      <div className="flex items-center gap-2">
        <button onClick={onBack} className="p-2 hover:bg-gray-200 rounded-full transition-colors text-gray-600 font-bold">
            &larr; 
        </button>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex justify-between items-start mb-6">
             ...
             <div className="flex gap-2">
                ...
                <button className="px-3 py-1.5 bg-white border border-gray-300 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-50 shadow-sm">
                    Edit
                </button>
                <button className="px-3 py-1.5 bg-red-50 border border-red-200 text-red-600 rounded-md text-sm font-medium hover:bg-red-100 shadow-sm">
                    Delete
                </button>
             </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="text-2xl font-bold text-green-600 flex items-baseline gap-1">
            1<span className="text-gray-400 text-base font-normal">/60 min</span>
          </div>
          <p className="text-xs text-gray-400 mt-1">25/1000 hour</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-10">
         <div className="p-6 pb-2">
            ...
            <p className="text-xs text-gray-500 mt-2">Showing entries 1 to {logs.length} of {logs.length} total</p>
         </div>
         ...
         {loading ? (
             ...
             <div className="mt-4">
                {/* Custom Table Header */}
                <div className="grid grid-cols-12 gap-4 px-6 py-2 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">
                        ...
                        return (
                            <div key={log.id} className="group transition-colors">
                                ...
                                <div 
                                    ...
                                    className={`grid grid-cols-12 gap-4 px-6 py-4 text-sm cursor-pointer hover:bg-gray-50 items-center ${isExpanded ? 'bg-gray-50' : ''}`}
                                >
