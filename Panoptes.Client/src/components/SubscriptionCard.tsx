  ...
  return (
    <div 
      className={`
        ...
        shadow-sm hover:scale-[1.005] hover:shadow-md
        ${styles.gradient}
        grid grid-cols-12 gap-4 items-center
      `}
    >
      {/* --- COL 1: NAME, TYPE & URL (Span 4 cols) --- */}
