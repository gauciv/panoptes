  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white dark:bg-[#0a0a0a] border border-[#006A33]/30 shadow-xl dark:shadow-[0_0_15px_rgba(0,106,51,0.1)] w-full max-w-md transform transition-all">
          {/* Header */}
          <div className="px-6 py-4 border-b border-[#006A33]/30 bg-gray-50 dark:bg-[#050505]">
            <h3 className="text-lg font-medium text-[#006A33] dark:text-[#00ff66]">
              New Subscription
            </h3>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="px-6 py-4 space-y-4 bg-white dark:bg-[#0a0a0a]">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#006A33]/30 bg-white dark:bg-[#050505] text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#006A33] focus:border-[#006A33]"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border bg-white dark:bg-[#050505] text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#006A33] focus:border-[#006A33] ${
              ...
              <div>
                <label htmlFor="walletAddresses" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Wallet Addresses (Optional)
                </label>
                <textarea
                  id="walletAddresses"
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-[#006A33]/30 bg-white dark:bg-[#050505] text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#006A33] focus:border-[#006A33] font-mono text-xs"
              ...
              <div className="bg-[#006A33]/10 dark:bg-[#006A33]/20 border border-[#006A33]/30 p-3">
                <div className="flex">
                  <svg className="w-5 h-5 text-[#006A33] mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                  <p className="text-sm text-[#006A33] dark:text-[#00ff66]">
            ...
            {/* Footer */}
            <div className="px-6 py-4 border-t border-[#006A33]/30 bg-gray-50 dark:bg-[#050505] flex justify-end space-x-3">
              <button
                type="button"
                onClick={handleClose}
                className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a0a0a] border border-[#006A33]/30 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006A33]"
              >
                Cancel
              </button>
              <button
                ...
                className={`px-4 py-2 text-sm font-medium text-white border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006A33] ${
      ...
      {showValidationWarning && (
        <div className="fixed inset-0 z-[60] overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-white dark:bg-[#0a0a0a] border border-[#006A33]/30 shadow-xl dark:shadow-[0_0_15px_rgba(0,106,51,0.1)] max-w-md w-full p-6">
              <div className="flex items-start mb-4">
                ...
                <div className="ml-3 flex-1">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Cannot Create Subscription</h3>
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">{validationWarningMessage}</p>
              ...
              <div className="flex justify-end mt-6">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-white bg-[#006A33] border border-[#006A33] hover:bg-[#008844] hover:shadow-[0_0_15px_rgba(0,106,51,0.5)]"
                >
                  Close
                </button>
              </div>
