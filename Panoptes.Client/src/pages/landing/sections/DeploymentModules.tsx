...
const modules = [
  {
    ...
    icon: Crosshair,
    desc: 'Execute trades within the same block. Detect price discrepancies across DEXs and dispatch transaction payloads before the mempool clears.',
    status: 'ACTIVE',
    color: 'text-sentinel',
  ...
  },
  {
    id: 'MOD_02',
    title: 'STATE_SYNC',
    subtitle: 'Live Database Indexing',
    icon: Database,
    desc: 'Maintain a perfect mirror of on-chain state in your local Postgres/Redis. Zero polling lag. Updates trigger immediately upon block finality.',
    status: 'STANDBY',
    color: 'text-blue-400',
  ...
  },
  {
    ...
    icon: ShieldAlert,
    desc: 'Monitor blacklist addresses and sanctioned entities. Auto-freeze user accounts or reject deposits the moment a flagged UTxO is detected.',
    status: 'ACTIVE',
    color: 'text-red-400',
